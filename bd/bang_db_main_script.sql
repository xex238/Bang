...
/*-----------------------Add_updates-------------------------------*/
ALTER TABLE [dbo].[User]
ADD [achievements_ID] [int] NOT NULL;
GO
...
/*---------------------------Add_updates---------------------------*/
ALTER TABLE [dbo].[User]  
WITH CHECK ADD  CONSTRAINT [FK_User_Achievements] FOREIGN KEY([achievements_ID])
